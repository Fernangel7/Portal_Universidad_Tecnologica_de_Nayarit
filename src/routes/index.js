...
main_routes.get("/transparencia/marco-normativo", IndexController.MarcoNormativo)
main_routes.get("/transparencia/estructura-organizacional", IndexController.EstructuraOrganizacional)
main_routes.get("/transparencia/convocatorias", IndexController.Convocatorias)
main_routes.get("/transparencia/infraestructura", IndexController.Infraestructura)
main_routes.get("/transparencia/indicadores", IndexController.Indicadores)
